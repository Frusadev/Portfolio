...
import { getCurrentUser, getOptionalUser } from "@/app/actions/auth";
        ...
        <header className="mb-12 space-y-6">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {post.tags?.map((tag) => (
              <span
                key={tag}
                className="px-3 py-1 bg-red-950/5 text-red-950 text-xs font-bold uppercase tracking-widest border border-red-950/20"
              >
                {tag}
              </span>
            ))}
