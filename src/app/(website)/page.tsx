  ...
  return (
    <div className="w-full min-h-full md:h-full md:inline-block md:min-w-full bg-background">
      <div className="grid grid-cols-2 md:grid-cols-none md:grid-rows-3 md:grid-flow-col md:auto-cols-[max(300px,22vw)] w-full min-h-full md:h-full border-l-4 md:border-l-[0.3vw] border-t-4 md:border-t-[0.3vw] border-red-950 bg-background md:w-fit">
        {/* 1. Hero / Intro Card - Large (Cols 1-2, Rows 1-2) */}
        ...
        {/* 2. GitHub Activity (The contrib box - 2nd in grid, Cols 1-2, Row 3) */}
        <div className="col-span-2 md:col-span-2 md:row-span-1 border-r-4 border-b-4 md:border-r-[0.3vw] md:border-b-[0.3vw] border-red-950 hover:bg-red-950/5 transition-colors bg-background overflow-hidden min-h-[160px] md:min-h-0">
          <GithubActivity data={githubData} />
        </div>

        {/* 3. Column 3 - Focus (Row 1) */}
        ...
        {/* 3. Column 3 - Location / Time (Row 2) */}
        ...
        {/* 5. Column 5 - Don't Press Game (Row 3) */}
        ...
        {/* 6 & 7. Columns 6-7 - Vibe Code Claim (Row 1) */}
        ...
        {/* 6 & 7. Columns 6-7 - Marquee Banner (Row 2) */}
        ...
        {/* 6 & 7. Columns 6-7 - Contact/Social CTA (Row 3) */}
        ...
        {/* 8. Column 8 - Coffee Filler (Row 1) */}
        ...
        {/* 8. Column 8 - Pixel Perfect Filler (Row 2) */}
        ...
        {/* 8. Column 8 - Dodging Button (Row 3) */}
        ...
        {/* 9. Column 9 - Irregular Clock (Row 1) */}
        ...
        {/* 9. Column 9 - Day Progress Bar (Row 2) */}
