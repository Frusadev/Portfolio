...
export const user = pgTable(
  "user",
  {
    ...
    subscriptionStatus: text("subscription_status").default("none").notNull(), // "none" | "pending" | "pending_update" | "active" | "cancel_at_period_end" | "cancelled"
  ...
  (table) => [
    ...
    index("user_dodo_subscription_id_idx").on(table.dodoSubscriptionId),
